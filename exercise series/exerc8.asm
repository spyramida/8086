...
MAIN PROC FAR
    ...
    JNE UNTIL_ENTER_IS_PRESSED
   
    PRINT_STR NEWLINE  ;allagh grammhs
    
    
    POP BX
    MOV AL,BL  ;2os DEKADIKOS ESTW X2
    
    POP BX
    MOV BH,BL   ;1os DEKADIKOS ESTW X1 STON BH SE ASCII FORMAT  
    
    MOV BL,AL   ;2os DEKADIKOS ESTW X2 STON BL SE ASCII FORMAT
    ...
    ;A8ROISMA SE HEX MORFH
    PRINT_STR MSG2  ;"ATHR="
    MOV AL,BL
    ADD AL,BH   ;AL=X1+X2  
    
    
    ;TYPWSE TA HEX PSIFIA TOY AL (1 'H 2) 
    CALL PRINT_HEX_DIGITS_FROM_AL      
    
    PRINT_STR SPACE
    
    
    ;DIAFORA SE HEX MORFH KAI ME PROSHMO
    PRINT_STR MSG3  ;"DIAF="
    
    ;APOFASISE GIA PROSHMO       BH=X1 BL=X2 DIAF=X1-X2
    CMP BH,BL
    JGE X1_MEGALYTERO_H_ISO_X2
    
    ;TYPWMA MEION PROSHMO KAI EURESH DIAFORAS
    PRINT MINUS                              
    MOV AL,BL
    SUB AL,BH   ;AL=X2-X1>0 (8ETIKH POSOTHTA, MEGALO MEION MIKRO)
    JMP DIAFORA_UPOLOGISTHKE
    
    
    X1_MEGALYTERO_H_ISO_X2:
    MOV AL,BH
    SUB AL,BL   ;AL=X1-X2>0   
    
    DIAFORA_UPOLOGISTHKE:
    ;TUPWMA DIAFORAS
    CALL PRINT_HEX_DIGITS_FROM_AL    
